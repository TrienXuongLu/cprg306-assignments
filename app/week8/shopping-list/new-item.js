                ...
                <div className="flex pb-5">
                    <form onSubmit={handleSubmit} className="w-80 h-52 text-white border rounded">
                        <div className="p-2">
                            ...
                            <input className="max-w-full w-80 border rounded text-black h-8" value={name} type="text" id="name" onChange={(event) => setName(event.target.value)} required placeholder="  Item Name" />
                        </div>
